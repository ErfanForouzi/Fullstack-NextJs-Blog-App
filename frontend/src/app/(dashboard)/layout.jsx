  ...
  return (
    <div className="bg-secondary-0">
      <div className="grid grid-cols-12 grid-rows-[auto_1fr] h-screen">
        ...
        <div className="grid-cols-12 col-span-12 lg:col-span-9 xl:col-span-10 row-span-1">
          <Header />
        </div>
        <main className="grid-cols-12 col-span-12 lg:col-span-9 xl:col-span-10 
        bg-secondary-100 rounded-tr-3xl p-4 md:p-6 overflow-y-auto">
